...
function UpdatePlayerData()
	...
	if (bspec == true) then
			...
			if ( GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= nil and GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= 1000) then
				...
				m_LocalPlayer = Players[GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID)];
			end
	end
end
...
function Initialize()
	...
	LuaEvents.DiplomacyRibbon_Click.Add( UpdatePlayerData );
