	...
	if (Game:GetProperty("SPEC_NUM") ~= nil) then
		...
		if (bspec == true) then
			if ( GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= nil and GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= 1000) then
				pPlayer = Players[GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID)];
			end
		end
...
function AddGovernorShared(governor:table)
	...
	if (Game:GetProperty("SPEC_NUM") ~= nil) then
		...
		if (bspec == true) then
			if ( GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= nil and GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= 1000) then
				pLocalPlayer = Players[GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID)];
			end
		end
	...
	if (Game:GetProperty("SPEC_NUM") ~= nil) then
		...
		if (bspec == true) then
			if ( GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= nil and GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= 1000) then
				...
				SetButtonTexture(governorInstance.GovernorDetailsButton, "Controls_Button");
				governorInstance.GovernorDetailsButton:RegisterCallback(Mouse.eLClick, OnNameButton);
				governorInstance.GovernorDetailsButton:SetDisabled(false);
			end
		end
...
function Open(playerID:number, cityID:number)
	...
	if (bspec == true) then
			...
			if ( GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= nil and GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID) ~= 1000) then
				playerID = GameConfiguration.GetValue("OBSERVER_ID_"..spec_ID)
			end
